...
echo -e "	[+]$blue Special Greetz To$nc :$yellow {_mr.ddos_ , Ha3MrX, Tunisian Eagles}$nc [+]"
echo ""
echo -e "$yellow Select From Menu : $nc"
echo ""
echo -e "		$red 1 : Brute Force Facebook Account$nc"
echo -e "		$green 2 : Brute Force Gmail Account$nc"
echo -e "		$Cyan 3 : Brute Force Instagram Account$nc"
echo -e "		$yellow 4 : Brute Force Twitter Account$nc"
